...
public class MyFilePickerDialog extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public MyFilePickerDialog(@NonNull Context context) {
        super(context);
    ...
    public MyFilePickerDialog(Context context, DialogProperties properties) {
        super(context);
        this.context = context;
    ...
    public MyFilePickerDialog(Context context, DialogProperties properties, int themeResId) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFileListAdapter = new MyFileListAdapter(internalList, context, properties);
        mFileListAdapter.setInitialParams(new int[]{selected_f_num,selected_f_length},paths);
        mFileListAdapter.setNotifyItemCheckedListener(new NotifyItemChecked() {
            ...
            public void notifyCheckBoxIsClicked() {
                ...
                if (size == 0) {
                    ...
                    String button_label = positiveBtnNameStr + " (已选" + (size + selected_f_num)
                            + "个，共" + new DecimalFormat("#.00").format((temp + selected_f_length) / 1024 / 1024) + "M" + ") ";
...
//                if (MarkedItemList.getFileCount() + selected_f_num > 5) {
