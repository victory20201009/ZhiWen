    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                NineGridLayout.this.onClickImageListener.onClickImage(v,i, url, mUrlList);
            }
        });
        return imageView;
    }
...
//        params.width = width;
    ...
    protected  boolean displayOneImage(final RatioImageView imageView, String url, final int parentWidth){
        ...
        return true;// true 代表按照九宫格默认大小显示(此时不要调用setOneImageLayoutParams)；false 代表按照自定义宽高显示。
...
//    }
    ...
    public  DisplayImageOptions getPhotoImageOption() {
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(true)
                .showImageForEmptyUri(R.drawable.ic_loading).showImageOnFail(R.drawable.ic_loadingerr)
    ...
    public interface  OnClickImageListener{
        void onClickImage(View v,int position, String url, ArrayList<String> urlList);
    }
}
